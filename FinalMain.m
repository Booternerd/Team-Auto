                ...
                if(s1<3 && s2<3 && s3<3 && s4<3 ...
                    ...
                    if (s1>0)
                        ...
                        for i=1:s1
                            Pxx = Px(nb);
                            Pyy = Py(nb);
                            StringName=sprintf('C MF %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f',Pxx,Pyy,154.82,rad2deg(orie(i))-box.b1(4),box.b1(1),box.b1(2),zp,v);
                            pause(0.2);
                            fwrite(socket, StringName);
                            nb = nb + 1;
                            zp = zp + 14;
                    ...
                    if (s2>0)
                        ...
                        for i=1:s2
                            Pxx = Px(nb);
                            Pyy = Py(nb);
                            StringName=sprintf('C MF %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f',Pxx,Pyy,154.82,rad2deg(orie(i))-box.b2(4),box.b2(1),box.b2(2),zp,v);
                            pause(0.2);
                            fwrite(socket, StringName);
                            nb = nb + 1;
                            zp = zp + 14;
                    ...
                    if (s3>0)
                        ...
                        for i=1:s3
                            Pxx = Px(nb);
                            Pyy = Py(nb);
                            StringName=sprintf('C MF %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f',Pxx,Pyy,154.82,rad2deg(orie(i))-box.b3(4),box.b3(1),box.b3(2),zp,v);
                            pause(0.2);
                            fwrite(socket, StringName);
                            nb = nb + 1;
                            zp = zp + 14;
                    ...
                    if (s4>0)
                        ...
                        for i=1:s4
                            Pxx = Px(nb);
                            Pyy = Py(nb);
                            StringName=sprintf('C MF %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f',Pxx,Pyy,154.82,rad2deg(orie(i))-box.b4(4),box.b4(1),box.b4(2),zp,v);
                            pause(0.2);
                            fwrite(socket, StringName);
                            nb = nb + 1;
                            zp = zp + 14;
